...
208 parameters from `WING_PARAM_CATALOG`.
...
| `/bus/{n}/col` | int | 1..18 |  |  | all | 1=Blue, 2=Azure, 3=Indigo, 4=Turquoise, 5=Green, 6=Lime, 7=Yellow, 8=Brown, 9=Red, 10=Salmon, 11=Magenta, 12=Purple, 13=Amber, 14=Sky Blue, 15=Orange Red, 16=Mint Green, 17=Gray, 18=White |
...
| `/bus/{n}/eq/mdl` | enum | STD, SOUL, E88, E84, F110, PULSAR, PIA |  |  | all |  |
| `/bus/{n}/eq/mix` | float | 0..125 | % |  | all |  |
| `/bus/{n}/eq/lg` | float | -15..15 | dB |  | all |  |
| `/bus/{n}/eq/lf` | float | 20..20000 | Hz |  | all |  |
| `/bus/{n}/eq/lq` | float | 0.44..10 |  |  | all |  |
| `/bus/{n}/eq/leq` | enum | PEQ, SHV, CUT, BW6, BW12, BS12, LR12, BW18, BW24, BS24, LR24, BW48, LR48 |  |  | all |  |
| `/bus/{n}/eq/1g` | float | -15..15 | dB |  | all |  |
| `/bus/{n}/eq/1f` | float | 20..20000 | Hz |  | all |  |
| `/bus/{n}/eq/1q` | float | 0.44..10 |  |  | all |  |
| `/bus/{n}/eq/2g` | float | -15..15 | dB |  | all |  |
| `/bus/{n}/eq/2f` | float | 20..20000 | Hz |  | all |  |
| `/bus/{n}/eq/2q` | float | 0.44..10 |  |  | all |  |
| `/bus/{n}/eq/3g` | float | -15..15 | dB |  | all |  |
| `/bus/{n}/eq/3f` | float | 20..20000 | Hz |  | all |  |
| `/bus/{n}/eq/3q` | float | 0.44..10 |  |  | all |  |
| `/bus/{n}/eq/4g` | float | -15..15 | dB |  | all |  |
| `/bus/{n}/eq/4f` | float | 20..20000 | Hz |  | all |  |
| `/bus/{n}/eq/4q` | float | 0.44..10 |  |  | all |  |
| `/bus/{n}/eq/5g` | float | -15..15 | dB |  | all |  |
| `/bus/{n}/eq/5f` | float | 20..20000 | Hz |  | all |  |
| `/bus/{n}/eq/5q` | float | 0.44..10 |  |  | all |  |
| `/bus/{n}/eq/6g` | float | -15..15 | dB |  | all |  |
| `/bus/{n}/eq/6f` | float | 20..20000 | Hz |  | all |  |
| `/bus/{n}/eq/6q` | float | 0.44..10 |  |  | all |  |
| `/bus/{n}/eq/hg` | float | -15..15 | dB |  | all |  |
| `/bus/{n}/eq/hf` | float | 20..20000 | Hz |  | all |  |
| `/bus/{n}/eq/hq` | float | 0.44..10 |  |  | all |  |
| `/bus/{n}/eq/heq` | enum | PEQ, SHV, CUT, BW6, BW12, BS12, LR12, BW18, BW24, BS24, LR24, BW48, LR48 |  |  | all |  |
| `/bus/{n}/eq/tilt` | float | -6..6 | dB |  | all |  |

...
100 parameters from `WING_PARAM_CATALOG`.
...
| `/main/{n}/eq/mdl` | enum | STD, SOUL, E88, E84, F110, PULSAR, PIA |  |  | all |  |
| `/main/{n}/eq/mix` | float | 0..125 | % |  | all |  |
| `/main/{n}/eq/lg` | float | -15..15 | dB |  | all |  |
| `/main/{n}/eq/lf` | float | 20..20000 | Hz |  | all |  |
| `/main/{n}/eq/lq` | float | 0.44..10 |  |  | all |  |
| `/main/{n}/eq/leq` | enum | PEQ, SHV, CUT, BW6, BW12, BS12, LR12, BW18, BW24, BS24, LR24, BW48, LR48 |  |  | all |  |
| `/main/{n}/eq/1g` | float | -15..15 | dB |  | all |  |
| `/main/{n}/eq/1f` | float | 20..20000 | Hz |  | all |  |
| `/main/{n}/eq/1q` | float | 0.44..10 |  |  | all |  |
| `/main/{n}/eq/2g` | float | -15..15 | dB |  | all |  |
| `/main/{n}/eq/2f` | float | 20..20000 | Hz |  | all |  |
| `/main/{n}/eq/2q` | float | 0.44..10 |  |  | all |  |
| `/main/{n}/eq/3g` | float | -15..15 | dB |  | all |  |
| `/main/{n}/eq/3f` | float | 20..20000 | Hz |  | all |  |
| `/main/{n}/eq/3q` | float | 0.44..10 |  |  | all |  |
| `/main/{n}/eq/4g` | float | -15..15 | dB |  | all |  |
| `/main/{n}/eq/4f` | float | 20..20000 | Hz |  | all |  |
| `/main/{n}/eq/4q` | float | 0.44..10 |  |  | all |  |
| `/main/{n}/eq/5g` | float | -15..15 | dB |  | all |  |
| `/main/{n}/eq/5f` | float | 20..20000 | Hz |  | all |  |
| `/main/{n}/eq/5q` | float | 0.44..10 |  |  | all |  |
| `/main/{n}/eq/6g` | float | -15..15 | dB |  | all |  |
| `/main/{n}/eq/6f` | float | 20..20000 | Hz |  | all |  |
| `/main/{n}/eq/6q` | float | 0.44..10 |  |  | all |  |
| `/main/{n}/eq/hg` | float | -15..15 | dB |  | all |  |
| `/main/{n}/eq/hf` | float | 20..20000 | Hz |  | all |  |
| `/main/{n}/eq/hq` | float | 0.44..10 |  |  | all |  |
| `/main/{n}/eq/heq` | enum | PEQ, SHV, CUT, BW6, BW12, BS12, LR12, BW18, BW24, BS24, LR24, BW48, LR48 |  |  | all |  |
| `/main/{n}/eq/tilt` | float | -6..6 | dB |  | all |  |
